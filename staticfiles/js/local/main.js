...
window.addEventListener('scroll', function() {
    ...
    if(position.top <= window.innerHeight - (res + course[0].clientHeight - 10)){
    ...
    if(course[1].getBoundingClientRect().top <= window.innerHeight - (res + course[1].clientHeight - 40)){
    ...
    if(course[2].getBoundingClientRect().top <= window.innerHeight - (res + course[2].clientHeight - 50)){
    ...
    if(course[3].getBoundingClientRect().top <= window.innerHeight - (res + course[3].clientHeight - 40)){
